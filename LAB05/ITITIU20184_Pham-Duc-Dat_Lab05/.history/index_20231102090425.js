...
function update() {
  ...
  var color = d3.scaleSequential()
    .interpolator(d3.interpolateRgbBasis(["#BEADFA", "#FF7676", "#610C9F"]))
  ...
  rect
    ...
    .transition()
    .duration(100)
    .style("transform", function(d, i) { return "translate(0, " + (i * 30) + "px"});
    .on("start", function () { d3.select(this).attr("fill", "#D0BFFF"); }) // highlight start of transition
    .attr("width", d => x(d['GRDP-VND']))
  ...
  text
    ...
    .attr("y", (d, i) => y(d["province"]) + y.bandwidth() / 1.5)
    .attr("fill", "#232D3F")
    .text(d => d["province"]);
