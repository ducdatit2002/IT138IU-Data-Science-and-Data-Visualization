    ...
    console.log(error);
       ...
       var padding = 20;
           ...
           .domain ([ d3.min(newdata, function (d) {return d.case}), d3.max(newdata, function (d) {return d.case})])
            ...
            .style("opacity", 0.7)      
            .style("stroke", "red")    
svg.append("text").attr("x", w-100).attr("y", 50).text("Case > 0").style("font-size", "15px").attr("alignment-baseline","middle")
svg.append("text").attr("x", w-100).attr("y", 70).text("Case < 0").style("font-size", "15px").attr("alignment-baseline","middle")
